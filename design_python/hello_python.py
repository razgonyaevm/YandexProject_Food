...
class Ui_Hello_Window(object):
    def setupUi(self, Hello_Window):
        ...
        self.pushButton.setGeometry(QtCore.QRect(170, 380, 271, 26))
    ...
    def retranslateUi(self, Hello_Window):
        ...
        self.change.setText(_translate("Hello_Window", "Изменить рецепт"))
        self.remove.setText(_translate("Hello_Window", "Удалить из меню"))
        self.add.setText(_translate("Hello_Window", "Дополнить меню"))
        self.make_order.setText(_translate("Hello_Window", "Сделать заказ"))
        self.exit_button.setText(_translate("Hello_Window", "Выйти"))
        self.pushButton.setText(_translate("Hello_Window", "Сформировать список покупок"))
